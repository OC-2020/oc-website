...
export default (props) => {
  ...
  const closeModal = () => setModalOpen(false)
	...
	return (
      ...
      <Button
				{...props}
        onClick={() => { setModalOpen(true); convert('AW-564308269/AKciCNaHte0BEK3Sio0C') }}
        variant="round"
      >
        Shop<br />Now
      </Button>
			...
			>
				...
				>
					<svg width="34" height="34"><g transform="translate(1 1)" fill="none" fill-rule="evenodd"><circle stroke="#44474F" fill="#FFF" cx="16" cy="16" r="16"/><path d="M22.679 10.94L17.619 16l5.06 5.06-1.62 1.619L16 17.618l-5.06 5.06-1.619-1.619 5.06-5.06-5.06-5.058 1.62-1.62L16 14.381l5.06-5.06 1.619 1.62z" fill="#44474F"/></g></svg>
				</button>
				...
				<Flex sx={{
					...
					<Flex sx={{
						...
						<Box sx={{
							...
							<Img fluid={single.childImageSharp.fluid} sx={{
						...
						<Flex sx={{
							...
							<Styled.h3 sx={{
								...
								Shop By The<br /> <span>Carton</span>
							</Styled.h3>
					...
					<Flex sx={{
						...
						<Box sx={{
							...
							<Img fluid={multiple.childImageSharp.fluid} sx={{
