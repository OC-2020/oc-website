/** @jsx jsx */
import { jsx, Styled, Container, Flex, Box, Text, Input, Button } from 'theme-ui'
    ...
    <footer sx={{
      ...
      <Container>
        <Flex sx={{
          ...
          <Box sx={{ textAlign: ['center', 'center', 'left'] }}>
            ...
            <Text sx={{
              ...
              Helping Canadians build <br />healthy eating habits
            </Text>
          </Box>
          ...
          <Flex sx={{
            ...
            <Flex as="form" action="https://usebasin.com/f/e954e7f86e07" method="POST" sx={{
              flexDirection: ['column', 'column', 'row'],
              alignItems: 'center'
            }}>
              <Input type="email"name="email" placeholder="Your Email" required sx={{
                maxWidth: '260px',
                height: '45px',
        ...
        <Text sx={{
          ...
          Copyright © Oat Canada 2020. <br />All Rights Reserved.
        </Text>
      </Container>
    </footer>
  )
