...
export default () => {
	const questionsLeft = [
		...
		},
		{
			...
			answer: "We are available at the following Costco warehouses. We're also expanding! If there's a specific Costco warehouse you'd like to find our product in, tell us in the contact form below!<br /><br />• Overlea - 42 Overlea Blvd, Toronto, ON M4H 1B6<br />• Etobicoke - 50 Queen Elizabeth Blvd, Etobicoke, ON M8Z 1M1<br />• Downsview - 100 Billy Bishop Way, Toronto, ON M3K 2C8<br />• Richmond Hill - 35 John Birchall Rd, Toronto, ON L4S 0B2<br />• Mississauga South - 3180 Laird Rd, Mississauga ON L5L 6A5<br />• Montreal - 300 Rue Bridge, Montreal, QC H3K 2C3<br />• Ottawa - 1405 Blair Towers Pl, Ottawa, ON K1J 1A5<br />• Pointe Claire - 5701 Transcanada Nord, Pointe Claire, QC H9R 1B7<br /><br />Make sure to look in the milk-alternatives section, usually found across the dairy fridge!"
		},
		{
			question: 'Is your oat milk Gluten-Free?',
			answer: 'We take celiacs disease very seriously. As such, after production our product immediately undergoes rigorous testing with Romer Labs in California for any traces of gluten.<br /><br /> As per Health Canada, a product having less than 20ppm of gluten is able to make the claim of gluten-free in Canada. Oat Canada’s Zero Sugar Oat Milk with expiration date of April 2022, July 2022, Oct 2022, December 2022, and March 2023 have less than 2.0 ppm which is considered gluten-free!<br /><br /> We test every batch and we’re are happy to provide results upon request. '
		},
		{
