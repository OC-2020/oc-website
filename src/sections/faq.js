...
export default () => {
	const questionsLeft = [
		...
		},
		{
			...
			answer: 'We take celiacs disease very seriously. As such, after production our product immediately undergoes rigorous testing with Romer Labs in California for any traces of gluten.<br /><br /> As per Health Canada, a product having less than 20ppm of gluten is able to make the claim of gluten-free in Canada. Oat Canada’s Zero Sugar Oat Milk with expiration date of April 2022, July 2022, Oct 2022, and December 2022 have less than 2.0 ppm which is considered gluten-free!<br /><br /> We test every batch and we’re are happy to provide results upon request. '
		},
		{
