  ...
  const {
    ...
    graphql`
      query {
        ...
        coco_color: file(relativePath: { eq: "logos/coco_color.png" }) {
          childImageSharp {
            fixed(width: 202, quality: 100) {
              ...GatsbyImageSharpFixed_withWebp_noBase64
            }
          }
        }
        ...
        coco_bw: file(relativePath: { eq: "logos/coco_bw.png" }) {
          childImageSharp {
            fixed(width: 202, quality: 100) {
              ...GatsbyImageSharpFixed_withWebp_noBase64
            }
		...
		<section sx={{
          ...
          <Flex sx={{
            ...
            animationIterationCount: 'infinite',
						...
						<Box as="a" href="https://www.cbc.ca/dragonsden/m_pitches/oat-canada" sx={{
							width: '250px',
							'img': {
								transform: 'scale(.9)'
							}
						...
						<Box as="a" href="https://www.blogto.com/eat_drink/2020/06/toronto-zero-sugar-oat-milk-costco/" sx={{
							width: '250px',
							'img': {
						...
						<Box as="a" href="https://www.thestar.com/local-vaughan/life/food-wine/2021/02/25/neighbourhood-eats-vaughan-markham-business-programs-help-couple-launch-oat-milk.html" sx={{
							width: '250px',
							'img': {
						...
						<Box as="a" href="https://humber.ca/today/news/humber-grad-s-oat-milk-charms-dragons" sx={{
							width: '250px',
							'img': {
								transform: 'scale(.9)'
							}
						...
						<Box as="a" href="https://cocoandcowe.com/2020/07/24/local-love-eloise-and-jamari-of-oat-canada/" sx={{
							width: '250px',
							'img': {
								transform: 'scale(.9)'
							}
						}}>
							<Img fixed={coco_color.childImageSharp.fixed} />
						</Box>
						<Box as="a" href="https://www.cbc.ca/dragonsden/m_pitches/oat-canada" sx={{
							width: '250px',
							'img': {
				...
				<Flex sx={{
					...
					<Box
						...
						sx={{ pb: '10px' }}
					>
						<Img fixed={dragons_bw.childImageSharp.fixed} style={{
							position: 'absolute'
						}} />
						<Img fixed={dragons_color.childImageSharp.fixed} style={{
					...
					>
						<Img fixed={blogto_bw.childImageSharp.fixed} style={{
							position: 'absolute'
						}} />
						<Img fixed={blogto_color.childImageSharp.fixed} style={{
							transition: 'opacity .2s ease-in-out',
					...
					>
						<Img fixed={toronto_bw.childImageSharp.fixed} style={{
							position: 'absolute'
						}} />
						<Img fixed={toronto_color.childImageSharp.fixed} style={{
							transition: 'opacity .2s ease-in-out',
					...
					>
						<Img fixed={humber_bw.childImageSharp.fixed} style={{
							position: 'absolute'
						}} />
						<Img fixed={humber_color.childImageSharp.fixed} style={{
							transition: 'opacity .2s ease-in-out',
					...
					<Box
						as="a"
						href="https://cocoandcowe.com/2020/07/24/local-love-eloise-and-jamari-of-oat-canada/"
						target="_blank"
						rel="noopener noreferrer"
						onMouseEnter={() => setCocoColor(true)}
						onMouseLeave={() => setCocoColor(false)}
					>
						<Img fixed={coco_bw.childImageSharp.fixed} style={{
							position: 'absolute'
						}} />
						<Img fixed={coco_color.childImageSharp.fixed} style={{
							transition: 'opacity .2s ease-in-out',
