    ...
    <Layout>
      <Container sx={{ width: ["100%", "100%", "950px"], mt: [4, 4, 8] }}>
        ...
        <Text sx={{ mt: 2 }}>
          ...
          <Text sx={{ mt: [4, 4, 6] }}>
            When we discovered oat milk it worked great for Jamari (because he’s lactose intolerant) and myself (I have a nut allergry), except for the fact that most oat milks were loaded with sugar. This was especially important to us because we come from families who suffer from diabetes—Jamari’s grandma would especially be on his case about watching his sugar intake because he’s legit a sugar addict. So, we tried to find ways to cut out sugar as much as possible, especially in things where it just didn’t make sense to have a lot in—like milk. 
          </Text>

          <Text sx={{ mt: [4, 4, 6] }}>
            We looked and looked for a zero sugar oat milk option but got tired of misleading labels like <i>“unsweetened”</i>{" "} or <i>“no sugar added”</i>{" "} on cartons with sugar contents as high as 10 grams to 17 grams of sugar in one serving. To give some perspective, that’s nearly half of the sugar found in a can of coke. So, we decided to take matters into our own hands. Thus, Oat Canada was born.
          </Text>

          <Text sx={{ mt: [4, 4, 6] }}>
            Our promise is to be transparent with how much sugar is in our products, so that’s why you see a giant zero on the front of our packaging—no guessing and no confusion from misleading labels. We’re proud to have launched the first zero sugar and keto-friendly barista oat milk in the market—especially to have launched our business right in the middle of the pandemic in 2020.
          </Text>

          <Text sx={{ mt: [4, 4, 6] }}>
            Today, just a year later after launch, we are now available in over 1,300 stores across Canada, including major retailers such as Loblaws, Costco East, Longo’s and Whole Foods (January 2022). An incredible feet considering Oat Canada only has one product in market at moment!
          </Text>
