  ...
  return (
    <Layout>
      ...
      <Container sx={{ width: ["100%", "100%", "950px"], mt: [4, 4, 8] }}>
        ...
        <Styled.h3 sx={{ mt: 2 }}>
          Official plant protein partner of Canada soccer
        </Styled.h3>
        <Flex
          sx={{
            alignItems: "center",
        ...
        <section sx={{ mt: [6, 6, "60px"] }}>
          <Text sx={{ mt: [4, 4, 6] }}>
            Toronto, ON (November 19, 2021) – Canada Soccer and Oat Canada
            announced today an exclusive multi-year partnership encompassing
            Canada Soccer’s National Teams and the Canadian Premier League
            (CPL). Oat Canada will be the “Official Plant Protein Partner” of
            Canada Soccer ahead of what is scheduled to be a very busy 2022 year
            including FIFA World Cup Qatar 2022™ Qualifiers matches and FIFA
            Women’s World Cup 2023™ Qualifers. Through this new partnership,
            this rapidly growing food and beverage company will become an
            integrated partner with both Canada Soccer and the Canadian Premier
            League and its eight clubs.
          </Text>

          <Text sx={{ mt: [4, 4, 6] }}>
            The agreement, negotiated by Canadian Soccer Business (CSB) will
            feature Oat Canada as the presenting sponsor of one Canada Soccer’s
            National Team matches per year, including a FIFA World Cup Qatar
            2022™ Qualifiers match. Oat Canada will also become an official
          ...
          <Text sx={{ mt: [4, 4, 6] }}>
            Oat Canada will have coast to coast reach through a full suite of
            sponsorships assets with all eight Canadian Premier League clubs
